...
var currTabRef = homeButton;
homeButton.addEventListener("click", function(e) {
  window.location.href = "index.html";
  currTabRef.style.color = "rgba(255,255,255,1)";
  currTabRef = homeButton;
  currTabRef.style.color = "rgba(0,255,0,1)";
  console.log("HEELLOO");
})

var aboutMeButton = document.getElementById("about_me");
aboutMeButton.addEventListener("click", function(e) {
  //Pick which one works later:
  //href:
  window.location.href = "about_me.html";
  currTabRef.style.color = "rgba(255,255,255,1)";
  currTabRef = aboutMeButton;
  currTabRef.style.color = "rgba(0,255,0,1)";
  console.log("HEELLOO");
  //or redirect:
...
portfolioButton.addEventListener("click", function(e) {
  ...
  currTabRef.style.color = "rgba(255,255,255,1)";
  currTabRef = portfolioButton;
  currTabRef.style.color = "rgba(0,255,0,1)";
  //or redirect:
  //window.location.replace("about_me.html");
})
var contactMeButton = document.getElementById("contact_me");
contactMeButton.addEventListener("click", function(e) {
  //Pick which one works later:
  //href:
  window.location.href = "contact_me.html";
  currTabRef.style.color = "rgba(255,255,255,1)";
  currTabRef = contactMeButton;
  currTabRef.style.color = "rgba(0,255,0,1)";
  //or redirect:
  //window.location.replace("about_me.html");
})
var contactMeButton = document.getElementById("3d");
contactMeButton.addEventListener("click", function(e) {
  //Pick which one works later:
  //href:
